...
class Conv2d_DS_insnorm(nn.Module):
    """ Depth seperable Conv layers with instance normalization"""
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, bias=False):
        # super(BQConv2d_DS, self).__init__(in_channels, out_channels, kernel_size, stride, padding, dilation, bias)
        super(Conv2d_DS_insnorm, self).__init__()
        # Depth wise convolution
        self.conv_dw = nn.Conv2d(
            in_channels=in_channels,
            out_channels=in_channels,
...
class MobileNetV1_c100_insnorm(nn.Module):
    def __init__(self) -> None:
        super().__init__()
        self.module_list = nn.Sequential(
            nn.Conv2d(3, 32, kernel_size=3, padding=1, stride=1, bias=False),
            ...
            nn.ReLU(),
            Conv2d_DS_insnorm(32, 64, kernel_size=3, padding=1, stride=1, bias=False),
            nn.InstanceNorm2d(64, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(64, 128, kernel_size=3, padding=1, stride=2, bias=False),
            nn.InstanceNorm2d(128, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(128, 128, kernel_size=3, padding=1, stride=1, bias=False),
            nn.InstanceNorm2d(128, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(128, 256, kernel_size=3, padding=1, stride=2, bias=False),
            nn.InstanceNorm2d(256, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(256, 256, kernel_size=3, padding=1, stride=1, bias=False),
            nn.InstanceNorm2d(256, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(256, 512, kernel_size=3, padding=1, stride=2, bias=False),
            nn.InstanceNorm2d(512, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(512, 512, kernel_size=3, padding=1, stride=1, bias=False),
            nn.InstanceNorm2d(512, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(512, 512, kernel_size=3, padding=1, stride=1, bias=False),
            nn.InstanceNorm2d(512, affine=True),
            ...
            nn.InstanceNorm2d(512, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(512, 1024, kernel_size=3, padding=1, stride=2, bias=False),
            nn.InstanceNorm2d(1024, affine=True),
            nn.ReLU(),
            Conv2d_DS_insnorm(1024, 1024, kernel_size=3, padding=1, stride=1, bias=False),
            nn.InstanceNorm2d(1024, affine=True),
            nn.AdaptiveAvgPool2d(1),
            nn.ReLU(),
            nn.Flatten(),
